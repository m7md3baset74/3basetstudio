    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <Image
            ...
            fill
            style={{
              objectFit: "contain",   // ← contain = no crop, full image always visible
              opacity: fading ? 0 : 1,
          ...
          <div style={{
            ...
            padding: ".65rem .9rem",
            background: "linear-gradient(to bottom, rgba(60, 60, 61, 0.88), transparent)",
            display: "flex", alignItems: "center", justifyContent: "space-between",
          }}>
            {/* Work counter */}
            <span style={{
              fontFamily: "var(--ff-caveat, 'Caveat', cursive)",
              fontSize: "0.9rem", letterSpacing: ".18em",
        ...
        {/* ══ DETAILS ══ */}
        <div style={{ padding: "1.3rem 1.3rem 1.8rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div>
              <small style={{
                display: "block", fontSize: ".58rem",
                letterSpacing: ".12em", color: "var(--muted)", marginBottom: ".1rem",
              }}>
                Asking Price
              </small>
              <span style={{
      ...
      <style>{`
        ...
        .modal-nav-prev:hover {
          background: linear-gradient(to right, rgba(4,3,6,.5), transparent);
        }
        .modal-nav-next:hover {
          background: linear-gradient(to left, rgba(4,3,6,.5), transparent);
        }
        .modal-nav-icon {
        ...
        body > div::-webkit-scrollbar { display: none; }
      `}</style>
    </div>
  );
}